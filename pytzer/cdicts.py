...
#WM13.bC['MgOH-Cl'] = coeffs.bC_MgOH_Cl_Harvie84
...
#WM13.theta['Mg-Na'] = coeffs.theta_Mg_Na_Harvie84
#WM13.theta['Ca-Na'] = coeffs.theta_Ca_Na_Harvie84
#WM13.theta['K-Na' ] = coeffs.theta_K_Na_Harvie84
#WM13.theta['Ca-Mg'] = coeffs.theta_Ca_Mg_Harvie84
#WM13.theta['K-Mg' ] = coeffs.theta_K_Mg_Harvie84
#WM13.theta['Ca-K' ] = coeffs.theta_Ca_K_Harvie84

# Table A7: anion-anion interactions
#WM13.theta['Cl-SO4'] = coeffs.theta_Cl_SO4_Harvie84
#WM13.theta['Cl-HSO4'] = coeffs.theta_Cl_HSO4_Harvie84
#WM13.theta['Cl-OH'] = coeffs.theta_Cl_OH_Harvie84
WM13.theta['HSO4-SO4'] = coeffs.theta_zero
#WM13.theta['OH-SO4'] = coeffs.theta_OH_SO4_Harvie84

# Table A8: c-a-a' triplets
WM13.psi['H-Cl-SO4'] = coeffs.psi_zero
#WM13.psi['Na-Cl-SO4'] = coeffs.psi_Na_Cl_SO4_Harvie84
#WM13.psi['Mg-Cl-SO4'] = coeffs.psi_Mg_Cl_SO4_Harvie84
#WM13.psi['Ca-Cl-SO4'] = coeffs.psi_Ca_Cl_SO4_Harvie84
#WM13.psi['K-Cl-SO4'] = coeffs.psi_K_Cl_SO4_Harvie84

#WM13.psi['H-Cl-HSO4'] = coeffs.psi_H_Cl_HSO4_Harvie84
#WM13.psi['Na-Cl-HSO4'] = coeffs.psi_Na_Cl_HSO4_Harvie84
#WM13.psi['Mg-Cl-HSO4'] = coeffs.psi_Mg_Cl_HSO4_Harvie84
#WM13.psi['Ca-Cl-HSO4'] = coeffs.psi_Ca_Cl_HSO4_Harvie84
#WM13.psi['K-Cl-HSO4'] = coeffs.psi_K_Cl_HSO4_Harvie84

WM13.psi['H-Cl-OH'] = coeffs.psi_zero
#WM13.psi['Na-Cl-OH'] = coeffs.psi_Na_Cl_OH_Harvie84
WM13.psi['Mg-Cl-OH'] = coeffs.psi_zero
#WM13.psi['Ca-Cl-OH'] = coeffs.psi_Ca_Cl_OH_Harvie84
#WM13.psi['K-Cl-OH'] = coeffs.psi_K_Cl_OH_Harvie84

WM13.psi['H-HSO4-SO4'] = coeffs.psi_zero
#WM13.psi['Na-HSO4-SO4'] = coeffs.psi_Na_HSO4_SO4_Harvie84
#WM13.psi['Mg-HSO4-SO4'] = coeffs.psi_Mg_HSO4_SO4_Harvie84
WM13.psi['Ca-HSO4-SO4'] = coeffs.psi_zero
#WM13.psi['K-HSO4-SO4'] = coeffs.psi_K_HSO4_SO4_Harvie84

WM13.psi['H-OH-SO4'] = coeffs.psi_zero
#WM13.psi['Na-OH-SO4'] = coeffs.psi_Na_OH_SO4_Harvie84
WM13.psi['Mg-OH-SO4'] = coeffs.psi_zero
WM13.psi['Ca-OH-SO4'] = coeffs.psi_zero
#WM13.psi['K-OH-SO4'] = coeffs.psi_K_OH_SO4_Harvie84

# Table A9: c-c'-a triplets
#WM13.psi['H-Na-Cl'] = coeffs.psi_H_Na_Cl_Harvie84
WM13.psi['H-Na-SO4'] = coeffs.psi_zero
#WM13.psi['H-Na-HSO4'] = coeffs.psi_H_Na_Cl_Harvie84

#WM13.psi['H-Mg-Cl'] = coeffs.psi_H_Mg_Cl_Harvie84
#WM13.psi['H-Mg-SO4'] = coeffs.psi_H_Mg_SO4_RC99
#WM13.psi['H-Mg-HSO4'] = coeffs.psi_H_Mg_HSO4_RC99

#WM13.psi['Ca-H-Cl'] = coeffs.psi_Ca_H_Cl_Harvie84
WM13.psi['Ca-H-SO4'] = coeffs.psi_zero
WM13.psi['Ca-H-HSO4'] = coeffs.psi_zero

#WM13.psi['H-K-Cl'] = coeffs.psi_H_K_Cl_Harvie84
#WM13.psi['H-K-SO4'] = coeffs.psi_H_K_SO4_Harvie84
#WM13.psi['H-K-HSO4'] = coeffs.psi_H_K_HSO4_Harvie84

#WM13.psi['Mg-Na-Cl'] = coeffs.psi_Mg_Na_Cl_Harvie84
#WM13.psi['Mg-Na-SO4'] = coeffs.psi_Mg_Na_SO4_Harvie84
WM13.psi['Mg-Na-HSO4'] = coeffs.psi_zero

#WM13.psi['Ca-Na-Cl'] = coeffs.psi_Ca_Na_Cl_Harvie84
#WM13.psi['Ca-Na-SO4'] = coeffs.psi_Ca_Na_SO4_Harvie84
WM13.psi['Ca-Na-HSO4'] = coeffs.psi_zero

#WM13.psi['K-Na-Cl'] = coeffs.psi_K_Na_Cl_Harvie84
#WM13.psi['K-Na-SO4'] = coeffs.psi_K_Na_SO4_Harvie84
WM13.psi['K-Na-HSO4'] = coeffs.psi_zero

#WM13.psi['Ca-Mg-Cl'] = coeffs.psi_Ca_Mg_Cl_Harvie84
#WM13.psi['Ca-Mg-SO4'] = coeffs.psi_Ca_Mg_SO4_Harvie84
WM13.psi['Ca-Mg-HSO4'] = coeffs.psi_zero

#WM13.psi['K-Mg-Cl'] = coeffs.psi_K_Mg_Cl_Harvie84
#WM13.psi['K-Mg-SO4'] = coeffs.psi_K_Mg_SO4_Harvie84
WM13.psi['K-Mg-HSO4'] = coeffs.psi_zero

#WM13.psi['Ca-K-Cl'] = coeffs.psi_Ca_K_Cl_Harvie84
