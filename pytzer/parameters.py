...
def bC_Na_CO3_PP82(T, P):
    ...
    b0 = PP82_eqMPH(T, [0.0362, 1.79e-3, -4.22e-5,])
    b1 = PP82_eqMPH(T, [1.51, 2.05e-3, -16.8e-5,])
    b2 = 0
    Cphi = 0.0052
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["CO3"])))
    C1 = 0
...
def bC_Na_HCO3_PP82(T, P):
    ...
    # I have no idea where MP98 got their T**2 parameters from
    #   or why they are so small.
    b0 = PP82_eqMPH(T, [0.028, 1.00e-3, -2.6e-5,])
    b1 = PP82_eqMPH(T, [0.044, 1.10e-3, -4.3e-5,])
    b2 = 0
    C0 = 0
    C1 = 0
    alph1 = 2
...
def bC_Cs_Cl_HM83(T, P):
    ...
    b0 = HM83_eq25(T, [0.03352, -1290.0, -8.4279, 0.018502, -6.7942e-6, 0,])
    b1 = HM83_eq25(T, [0.0429, -38.0, 0, 0.001306, 0, 0,])
    b2 = 0
    Cphi = HM83_eq25(T, [-2.62e-4, 157.13, 1.0860, -0.0025242, 9.840e-7, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Cs"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_Cl_HM83(T, P):
    ...
    b0 = HM83_eq25(T, [0.04808, -758.48, -4.7062, 0.010072, -3.7599e-6, 0,])
    b1 = HM83_eq25(T, [0.0476, 303.09, 1.066, 0, 0, 0.0470,])
    b2 = 0
    Cphi = HM83_eq25(T, [-7.88e-4, 91.270, 0.58643, -0.0012980, 4.9567e-7, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Li_Cl_HM83(T, P):
    ...
    b0 = HM83_eq25(T, [0.14847, 0, 0, -1.546e-4, 0, 0,])
    b1 = HM83_eq25(T, [0.307, 0, 0, 6.36e-4, 0, 0,])
    b2 = 0
    Cphi = HM83_eq25(T, [0.003710, 4.115, 0, 0, -3.71e-9, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Li"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Mg_SO4_PP86ii(T, P):
    ...
    b0 = PP86ii_eq29(T, [-1.0282, 8.4790e-3, -2.3366e-5, 2.1575e-8, 6.8402e-4, b0r,])
    b1 = PP86ii_eq29(T, [-2.9596e-1, 9.4564e-4, 0, 0, 1.1028e-2, b1r,])
    b2 = PP86ii_eq29(T, [-1.3764e1, 1.2121e-1, -2.7642e-4, 0, -2.1515e-1, b2r,])
    C0 = PP86ii_eq29(
        T, [1.0541e-1, -8.9316e-4, 2.5100e-6, -2.3436e-9, -8.7899e-5, C0r,]
    )
    valid = T <= 473
    return b0, b1, b2, C0, C1, alph1, alph2, omega, valid
...
def bC_K_SO4_HM86(T, P):
    ...
    b0 = HM86_eq8(T, [0, 7.476e-4, 0, 4.265e-3, -3.088, 0, 0,])
    b1 = HM86_eq8(T, [0.6179, 6.85e-3, 5.576e-5, -5.841e-2, 0, -0.90, 0,])
    b2 = 0
    Cphi = HM86_eq8(T, [9.15467e-3, 0, 0, -1.81e-4, 0, 0, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["SO4"])))
    C1 = 0
    alph1 = 1.4
    alph2 = -9
...
def bC_Na_SO4_HM86(T, P):
    ...
    b0 = HM86_eq8(T, [-1.727e-2, 1.7828e-3, 9.133e-6, 0, -6.552, 0, -96.90,])
    b1 = HM86_eq8(T, [0.7534, 5.61e-3, -5.7513e-4, 1.11068, -378.82, 0, 1861.3,])
    b2 = 0
    Cphi = HM86_eq8(
        T, [1.1745e-2, -3.3038e-4, 1.85794e-5, -3.9200e-2, 14.2130, 0, -24.950,]
    )
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["SO4"])))
    C1 = 0
    alph1 = 1.4
...
def bC_K_Cl_SRRJ87(T, P):
    ...
    b0 = SRRJ87_eq7(T, [0.0481, 0.592, -0.562,])
    b1 = SRRJ87_eq7(T, [0.2188, 1.500, -1.085,])
    b2 = 0
    Cphi = SRRJ87_eq7(T, [-0.790, -0.639, 0.613,]) * 1e-3  # *1e-3 presumably?
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_Cl_SRRJ87(T, P):
    ...
    # Parameters from SRRJ87 Table III
    b0 = SRRJ87_eq7(T, [0.0754, 0.792, -0.935,])
    b1 = SRRJ87_eq7(T, [0.2770, 1.006, -0.756,])
    b2 = 0
    Cphi = SRRJ87_eq7(T, [1.40, -1.20, 1.15,]) * 1e-3  # *1e-3 presumably?
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_BOH4_SRRJ87(T, P):
    ...
    # Parameters from SRRJ87 Table III
    b0 = SRRJ87_eq7(T, [0.1469, 2.881, 0,])
    b1 = SRRJ87_eq7(T, [-0.0989, -6.876, 0,])
    b2 = 0
    Cphi = SRRJ87_eq7(T, [-56.43, -9.56, 0,]) * 1e-3  # *1e-3 presumably?
...
def bC_Na_BOH4_SRRJ87(T, P):
    ...
    # Parameters from SRRJ87 Table III
    b0 = SRRJ87_eq7(T, [-0.0510, 5.264, 0,])
    b1 = SRRJ87_eq7(T, [0.0961, -10.68, 0,])
    b2 = 0
    Cphi = SRRJ87_eq7(T, [14.98, -15.7, 0,]) * 1e-3  # *1e-3 presumably?
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["BOH4"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Mg_BOH4_SRM87(T, P):
    ...
    b0 = SRM87_eqTableIII(T, [-0.6230, 6.496, 0,])
    b1 = SRM87_eqTableIII(T, [0.2515, -17.13, 0,])
    b2 = SRM87_eqTableIII(T, [-11.47, 0, -3.240,])
    C0 = 0
    C1 = 0
    alph1 = 1.4
    alph2 = 6
...
def bC_Ca_BOH4_SRM87(T, P):
    ...
    b0 = SRM87_eqTableIII(T, [-0.4462, 5.393, 0,])
    b1 = SRM87_eqTableIII(T, [-0.8680, -18.20, 0,])
    b2 = SRM87_eqTableIII(T, [-15.88, 0, -2.858,])
    C0 = 0
    C1 = 0
    alph1 = 1.4
    alph2 = 6
...
def b1_Ca_Cl_M88(T, P):
    ...
    return M88_eq13(T, [3.47870000e00, -1.54170000e-2, 0, 0, 0, 3.17910000e-5, 0, 0,])
...
def bC_Ca_SO4_M88(T, P):
    ...
    b0 = 0.15
    b1 = 3.00
    b2 = M88_eq13(T, [-1.29399287e2, 4.00431027e-1, 0, 0, 0, 0, 0, 0,])
    C0 = 0
    C1 = 0
    alph1 = 1.4
    alph2 = 12
...
def bC_Na_Cl_M88(T, P):
    ...
    b1 = M88_eq13(
        T, [-4.83060685e-1, 1.40677479e-3, 1.19311989e2, 0, 0, 0, 0, -4.23433299e00,]
    )
    b2 = 0
    Cphi = M88_eq13(
        T,
...
def bC_K_Cl_GM89(T, P):
    ...
    b1 = GM89_eq3(
        T, [-7.41559626e00, 0, 3.22892989e2, 1.16438557e00, 0, 0, 0, -5.94578140e00,]
    )
    b2 = 0
    Cphi = GM89_eq3(
        T,
...
def bC_K_SO4_GM89(T, P):
    ...
    b0 = GM89_eq3(
        T, [4.07908797e1, 8.26906675e-3, -1.41842998e3, -6.74728848e00, 0, 0, 0, 0,]
    )
    b1 = GM89_eq3(T, [-1.31669651e1, 2.35793239e-2, 2.06712594e3, 0, 0, 0, 0, 0,])
    b2 = 0
    Cphi = -0.0188
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["SO4"])))
    C1 = 0
...
def theta_K_Na_GM89(T, P):
    ...
    theta = GM89_eq3(T, [-5.02312111e-2, 0, 1.40213141e1, 0, 0, 0, 0, 0,])
    valid = (T >= 273.15) & (T <= 523.15)
    return theta, valid
...
def psi_Ca_K_Cl_GM89(T, P):
    ...
    psi = GM89_eq3(T, [4.76278977e-2, 0, -2.70770507e1, 0, 0, 0, 0, 0,])
    valid = (T >= 273.15) & (T <= 523.15)
    return psi, valid
...
def psi_K_Na_Cl_GM89(T, P):
    ...
    psi = GM89_eq3(T, [1.34211308e-2, 0, -5.10212917e00, 0, 0, 0, 0, 0,])
    valid = (T >= 273.15) & (T <= 523.15)
    return psi, valid
...
def psi_K_Na_SO4_GM89(T, P):
    ...
    psi = GM89_eq3(T, [3.48115174e-2, 0, -8.21656777e00, 0, 0, 0, 0, 0,])
...
def psi_K_Cl_SO4_GM89(T, P):
    ...
    psi = GM89_eq3(T, [-2.12481475e-1, 2.84698333e-4, 3.75619614e1, 0, 0, 0, 0, 0,])
    valid = (T >= 273.15) & (T <= 523.15)
    return psi, valid
...
def bC_H_Cl_CMR93(T, P):
    ...
    b0 = CMR93_eq31(T, [1.2859, -2.1197e-3, -142.5877, 0, 0, 0, 0, 0,])
    b1 = CMR93_eq31(T, [-4.4474, 8.425698e-3, 665.7882, 0, 0, 0, 0, 0,])
    b2 = 0
    Cphi = CMR93_eq31(T, [-0.305156, 5.16e-4, 45.52154, 0, 0, 0, 0, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["H"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def lambd_CO2_Na_HM93(T, P):
    ...
    lambd = HM93_eq(T, -5496.38465, -3.326566, 0.0017532, 109399.341, 1047.021567,)
    valid = (T >= 273.15) & (T <= 363.15)
    return lambd, valid
...
def lambd_CO2_K_HM93(T, P):
    ...
    lambd = HM93_eq(T, 2856.528099, 1.7670079, -0.0009487, -55954.1929, -546.074467,)
    valid = (T >= 273.15) & (T <= 363.15)
    return lambd, valid
...
def lambd_CO2_Ca_HM93(T, P):
    ...
    lambd = HM93_eq(T, -12774.6472, -8.101555, 0.00442472, 245541.5435, 2452.509720,)
    valid = (T >= 273.15) & (T <= 363.15)
    return lambd, valid
...
def lambd_CO2_Mg_HM93(T, P):
    ...
    lambd = HM93_eq(T, -479.362533, -0.541843, 0.00038812, 3589.474052, 104.3452732,)
    valid = (T >= 273.15) & (T <= 363.15)
    return lambd, valid
...
def lambd_CO2_SO4_HM93(T, P):
    ...
    lambd = HM93_eq(T, 2274.656591, 1.8270948, -0.00114272, -33927.7625, -457.015738,)
    valid = (T >= 273.15) & (T <= 363.15)
    return lambd, valid
...
def bC_Na_SO4_HPR93(T, P):
    ...
    b0 = HPR93_eq36(T, [0.006536438, -30.197349, -0.20084955,])
    b1 = HPR93_eq36(T, [0.87426420, -70.014123, 0.2962095,])
    b2 = 0
    Cphi = HPR93_eq36(T, [0.007693706, 4.5879201, 0.019471746,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["SO4"])))
    C1 = 0
    alph1 = 1.7
    alph2 = -9
...
def bC_H_HSO4_CRP94(T, P):
    ...
    b0 = CRP94_eq24(T, [0.227784933, -3.78667718, -0.124645729, -0.00235747806,])
    b1 = CRP94_eq24(T, [0.372293409, 1.50, 0.207494846, 0.00448526492,])
    b2 = 0
    C0 = CRP94_eq24(T, [-0.00280032520, 0.216200279, 0.0101500824, 0.000208682230,])
    C1 = CRP94_eq24(T, [-0.025, 18.1728946, 0.382383535, 0.0025,])
    alph1 = 2
    alph2 = -9
    omega = 2.5
    valid = (T >= 273.15) & (T <= 328.15)
...
def bC_H_SO4_CRP94(T, P):
    ...
    b0 = CRP94_eq24(T, [0.0348925351, 4.97207803, 0.317555182, 0.00822580341,])
    b1 = CRP94_eq24(T, [-1.06641231, -74.6840429, -2.26268944, -0.0352968547,])
    b2 = 0
    C0 = CRP94_eq24(T, [0.00764778951, -0.314698817, -0.0211926525, -0.000586708222,])
    C1 = CRP94_eq24(T, [0, -0.176776695, -0.731035345, 0,])
...
def bC_Na_I_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.1195, -1.01, 8.355,])
    b1 = MP98_eq15(T, [0.3439, -2.54, 8.28,])
    b2 = 0
    Cphi = MP98_eq15(T, [0.0018, 0, -0.835,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["I"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_Br_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.0973, -1.3, 7.692,])
    b1 = MP98_eq15(T, [0.2791, -1.06, 10.79,])
    b2 = 0
    Cphi = MP98_eq15(
        T, [0.00116, 0.058 * 2 ** 1.5, -0.93,]  # more accurate following PM16 model
    )
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
...
def bC_Na_F_MP98(T, P):
    ...
    b1 = MP98_eq15(
        T, [0.2107, 0, 8.7,]  # *1e-4 in MP98 Table A7 presumably a typo vs PM16 code
    )
    b2 = 0
    Cphi = MP98_eq15(
        T, [0, 0, -0.93,]  # 0 in MP98 Table A7 presumably a typo vs PM16 code
    )
...
def bC_K_Br_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.0569, -1.43, 7.39,])
    b1 = MP98_eq15(T, [0.2122, -0.762, 1.74,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.0018, 0.216, -0.7004,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_F_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.08089, -1.39, 2.14,])
    b1 = MP98_eq15(T, [0.2021, 0, 5.44,])
    b2 = 0
    Cphi = MP98_eq15(
        T,
        [
...
def bC_K_OH_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.1298, -0.946, 9.914,])  # copy of KI
    b1 = MP98_eq15(T, [0.32, -2.59, 11.86,])  # copy of KI
    b2 = 0
    Cphi = MP98_eq15(T, [0.0041, 0.0638, -0.944,])  # copy of KI
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["OH"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_I_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.0746, -0.748, 9.914,])
    b1 = MP98_eq15(T, [0.2517, -1.8, 11.86,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.00414, 0, -0.944,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["I"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_ClO3_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.0249, -1.56, 10.35,])
    b1 = MP98_eq15(T, [0.2455, -2.69, 19.07,])
    b2 = 0
    Cphi = MP98_eq15(T, [0.0004, 0.222, 9.29,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["ClO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_ClO3_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [-0.096, 15.1, 19.87,])
    b1 = MP98_eq15(T, [0.2841, -27, 31.8,])
    b2 = 0
    Cphi = MP98_eq15(T, [0, -19.1, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["ClO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_ClO4_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.0554, -0.611, 12.96,])
    b1 = MP98_eq15(T, [0.2755, -6.35, 22.97,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.00118, 0.0562, -1.623,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["ClO4"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_BrO3_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [-0.0205, -6.5, 5.59,])
    b1 = MP98_eq15(T, [0.191, 5.45, 34.37,])
    b2 = 0
    Cphi = MP98_eq15(T, [0.0059, 2.5, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["BrO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_BrO3_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [-0.129, 9.17, 5.59,])
    b1 = MP98_eq15(T, [0.2565, -20.2, 34.37,])
    b2 = 0
    Cphi = MP98_eq15(T, [0, -26.6, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["BrO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_NO3_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.0068, -2.24, 12.66,])
    b1 = MP98_eq15(T, [0.1783, -2.96, 20.6,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.00072, 0.594, -2.316,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["NO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_NO3_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [-0.0816, -0.785, 2.06,])
    b1 = MP98_eq15(T, [0.0494, -8.26, 64.5,])
    b2 = 0
    Cphi = MP98_eq15(T, [0.0066, 0, 3.97,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["NO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Mg_NO3_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.367125, -1.2322, 5.15,])
    b1 = MP98_eq15(T, [1.58475, 4.0492, 44.925,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.020625, 0, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Mg"] * i2c["NO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Ca_NO3_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.210825, 4.0248, 5.295,])
    b1 = MP98_eq15(T, [1.40925, -13.289, 91.875,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.020142, -15.435, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Ca"] * i2c["NO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_H_Br_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.196, -0.357, -2.049,])
    b1 = MP98_eq15(T, [0.3564, -0.913, 4.467,])
    b2 = 0
    Cphi = MP98_eq15(T, [0.00827, 0.01272, -0.5685,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["H"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Sr_Cl_MP98(T, P):
    ...
    b0 = MP98_eq15(
        T,
        [0.28575, -0.18367, 9.56 * 3 / 4,],  # from Pierrot_2018_Interaction_Model.xlsm
    )
    b1 = MP98_eq15(T, [1.66725, 0, 37.9 * 3 / 4,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.0013, 0, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Sr"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_NH4_Cl_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.0522, -0.597, 0.779,])
    b1 = MP98_eq15(T, [0.1918, 0.444, 12.58,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.00301, 0.0578, 0.21,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["NH4"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_NH4_Br_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.0624, -0.597, 0.779,])
    b1 = MP98_eq15(T, [0.1947, 0, 12.58,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.00436, 0, 0.21,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["NH4"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_NH4_Br_MP98typo(T, P):
    ...
    b1 = MP98_eq15(T, [0.1947, 0, 12.58,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.00436, 0, 0.21 * 1e5,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["NH4"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_NH4_F_MP98(T, P):
    ...
    b0 = MP98_eq15(T, [0.1306, 1.09, 0.95,])
    b1 = MP98_eq15(T, [0.257, 0, 5.97,])
    b2 = 0
    Cphi = MP98_eq15(T, [-0.0043, 0, 0,])
...
def bC_Na_HSO4_MP98(T, P):
    ...
    b0 = MP98_eqTableA3(T, [0.0544, -1.8478e-3, 5.3937e-5,])  # MP98 typo vs PM16 model
    b1 = MP98_eqTableA3(T, [0.3826401, -1.8431e-2, 0,])
    b2 = 0
...
def bC_H_SO4_MP98(T, P):
    ...
    b0 = MP98_eqTableA9_2(
        T,
        [0.0065, 0.134945, 0.022374, 7.2e-5,],  # typo in MP98 table (vs 2016 VB model)
    )
    b1 = MP98_eqTableA9_2(
        T,
        [
    ...
    b2 = 0
    C0 = MP98_eqTableA9_2(T, [0.008073, -0.113106, -0.003553, 3.57e-5,])
    C1 = MP98_eqTableA9_2(T, [-0.050799, 3.472545, -0.311463, 0.004037,])
    alph1 = 2
    alph2 = -9
    omega = 2.5
    valid = (T >= 273.15) & (T <= 523.15)
...
def bC_H_HSO4_MP98(T, P):
    ...
    b0 = MP98_eqTableA9_2(T, [0.239786, -1.209539, -0.004345, 0.000185,])
    b1 = MP98_eqTableA9_2(T, [0.352843, 0.087537, 0.038379, -0.000744,])
    b2 = 0
    C0 = MP98_eqTableA9_2(T, [-0.003234, 0.045792, 0.000793, -0.0000222,])
    C1 = MP98_eqTableA9_2(T, [-0.098973, 3.127618, -0.020184, -0.000316,])
    alph1 = 2
    alph2 = -9
    omega = 2.5
    valid = (T >= 273.15) & (T <= 523.15)
...
def psi_K_Cl_SO4_MP98(T, P):
    ...
    psi = GM89_eq3(T, [-2.12481e-1, 2.84698333e-4, 3.75619614e1, 0, 0, 0, 0, 0,])
    valid = (T >= 273.15) & (T <= 523.15)
    return psi, valid
...
def bC_K_BOH4_MP98(T, P):
    ...
    b1 = SRRJ87_eq7(T, [-0.0989, -6.876, 0,])
    b2 = 0
    Cphi = SRRJ87_eq7(T, [-56.43e-3, -0.956, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["BOH4"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_BOH4_MP98(T, P):
    ...
    b1 = SRRJ87_eq7(T, [0.0961, -10.68, 0,])
    b2 = 0
    Cphi = SRRJ87_eq7(T, [14.98e-3, -1.57, 0,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["BOH4"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_Cl_A99(T, P):
    ...
    b1 = A99_eq22(
        T, [0.206691413598171, 0.102544606022162, 0, 0, 0, -0.00188349608000903,]
    )
    b2 = 0
    C0 = A99_eq22(
        T, [-0.00133515934994478, 0, 0, 0.00234117693834228, -0.00075896583546707, 0,]
    )
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_H_Br_JESS(T, P):
    ...
    b0 = JESS_eq(T, P, [0.210904, -0.0111577, -0.0965749, -0.00485161,])
    b1 = JESS_eq(T, P, [0.324833, -0.141250, -0.287944, -0.0209720,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.00113432, -0.0110028, -0.0542243, 0.000704627,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["H"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_H_Cl_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.178627, 0.209336, 0.580887, 0.000743741,])
    b1 = JESS_eq(T, P, [0.288278, -0.757685, -2.38033, -0.00662854,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.000259560, -0.0628809, -0.219810, 1.46066e-5,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["H"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_H_ClO4_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.177990, -0.126144, -0.278470, -0.000346259,])
    b1 = JESS_eq(T, P, [0.282791, -0.469348, -0.990997, -0.0550796,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.00754498, 0.0103387, 0.000000, -0.00157682,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["H"] * i2c["ClO4"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_H_I_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.231988, -0.138301, -0.470802, -0.0212351,])
    b1 = JESS_eq(T, P, [0.419989, -0.344954, -0.859537, 0.0477403,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.00286688, 0.00703988, 0.000000, 0.00346557,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["H"] * i2c["I"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_H_NO3_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.116523, -0.0848453, -0.216476, -0.0109287,])
    b1 = JESS_eq(T, P, [0.351089, -0.830710, -2.43129, 0.0206574,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.00531372, -0.0289539, -0.123911, 0.00299856,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["H"] * i2c["NO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_Br_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.0547434, -0.420409, -1.13677, 0.00766319,])
    b1 = JESS_eq(T, P, [0.238709, -0.160445, -0.235802, 0.0172136,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.00145317, 0.0658735, 0.185412, -0.000339080,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_Cl_JESS(T, P):
    ...
    b0 = JESS_eq(T, P, [0.0478024, -0.359514, -1.00809, 0.0104416,])
    b1 = JESS_eq(T, P, [0.220310, -0.158289, -0.228114, 0.0198966,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.000751880, 0.0516663, 0.149612, -0.000853398,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_I_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.0706420, -0.176246, -0.291178, 0.0103160,])
    b1 = JESS_eq(T, P, [0.279022, -1.11921, -3.31506, -0.0125590,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.00335865, 0.000000, -0.0301254, -0.00160355,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["I"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_NO3_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [-0.0763632, -0.582629, -1.49134, -0.000422651,])
    b1 = JESS_eq(T, P, [0.0435708, -1.90996, -4.95256, 0.0795007,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.00526553, 0.101479, 0.274296, 0.00254839,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["NO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_K_OH_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.153478, -0.519124, -1.69587, 0.0274921,])
    b1 = JESS_eq(T, P, [0.184252, 0.107673, 0.539154, 0.000813086,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.000479227, 0.0899943, 0.295729, -0.00264638,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["K"] * i2c["OH"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Li_Br_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.173865, 0.174090, 0.523963, 0.00576938,])
    b1 = JESS_eq(T, P, [0.287573, -0.908258, -2.72816, -0.0110614,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.00505045, -0.0474007, -0.165446, -0.00114107,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Li"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Li_Cl_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.148491, 0.0993795, 0.288338, 0.00616159,])
    b1 = JESS_eq(T, P, [0.305863, -0.534953, -1.57812, 0.00327985,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.00363693, -0.0309516, -0.118649, -0.000747312,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Li"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Li_ClO4_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.194332, 0.0519232, 0.179439, -0.000735779,])
    b1 = JESS_eq(T, P, [0.435514, -0.694923, -2.09437, 0.00524685,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.00160986, -0.0229881, -0.0977900, 0.000703517,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Li"] * i2c["ClO4"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Li_I_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.176338, 0.000000, -0.129076, -0.00291167,])
    b1 = JESS_eq(T, P, [0.523319, 0.0858259, 0.810061, -0.000530723,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.0109604, -0.0457470, -0.125706, 0.000223867,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Li"] * i2c["I"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Li_NO3_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.140963, -0.285745, -0.959602, -0.00269645,])
    b1 = JESS_eq(T, P, [0.286879, 0.763311, 2.87993, 0.0225144,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.00543304, 0.00233974, 0.000000, 0.000892616,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Li"] * i2c["NO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Li_OH_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.0544861, -0.245358, -0.865967, 0.00588145,])
    b1 = JESS_eq(T, P, [-0.139320, -0.725360, -2.44668, 0.0583334,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.00433424, 0.0208725, 0.0579693, 0.00152371,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Li"] * i2c["OH"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_Br_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.0987329, -0.428710, -1.19150, 0.00937076,])
    b1 = JESS_eq(T, P, [0.285551, -0.452514, -1.24784, 0.000698698,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.000736067, 0.0467849, 0.124757, -0.00113162,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["Br"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_Cl_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-08]
    b0 = JESS_eq(T, P, [0.0779802, -0.429500, -1.21510, 0.0108697,])
    b1 = JESS_eq(T, P, [0.269983, -0.379473, -1.03405, 0.00877337,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.000918109, 0.0518882, 0.139812, -0.000952450,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["Cl"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_ClO4_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.0557192, -0.519285, -1.35911, 0.00925914,])
    b1 = JESS_eq(T, P, [0.280349, -1.02206, -2.73189, 0.0158837,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.00126494, 0.0944381, 0.269364, -0.000962511,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["ClO4"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_I_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.124139, -0.149852, -0.225275, 0.00691965,])
    b1 = JESS_eq(T, P, [0.317353, -1.47625, -4.67803, -0.0109580,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.000609691, -0.0485681, -0.197132, -0.000968575,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["I"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_NO3_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.00500042, -0.708908, -1.99654, 0.00501474,])
    b1 = JESS_eq(T, P, [0.200360, -0.879277, -2.23652, 0.0625764,])
    b2 = 0
    Cphi = JESS_eq(T, P, [-0.000347888, 0.153367, 0.461828, 0.000540176,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["NO3"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
def bC_Na_OH_JESS(T, P):
    ...
    # Coefficients obtained online [2019-08-09]
    b0 = JESS_eq(T, P, [0.0857078, -0.618667, -1.90371, 0.0278606,])
    b1 = JESS_eq(T, P, [0.276706, -0.443782, -1.30232, 0.0242386,])
    b2 = 0
    Cphi = JESS_eq(T, P, [0.00418666, 0.0982562, 0.285252, -0.00224765,])
    C0 = Cphi / (2 * np.sqrt(np.abs(i2c["Na"] * i2c["OH"])))
    C1 = 0
    alph1 = 2
    alph2 = -9
...
#         ,
#     ])
#     C0 = Cphi/(2*np.sqrt(np.abs(i2c['']*i2c[''])))
#     C1 = 0
#     alph1 = 2
#     alph2 = -9
#     omega = -9
