...
def salinity_to_totals_GP89(salinity=35):
    ...
    volumetric_salts = {"MgCl2": 0.05327, "CaCl2": 0.01033, "SrCl2": 9e-05}
    ...
    h2o = 1 - np.sum(gravimetric_salts.values()) / 1000  # fraction of H2O in solution
...
def salinity_to_totals_H73(salinity=35):
    ...
    H73.
    """
    # given in mMol/kg of solution in the paper
    ion_concentrations = {
        "Na": 478,
        "Mg": 54,
        "Ca": 10,
