...
"""He & Morse (1993) Geochim. Cosmochim. Acta 57(15), 3533-3554.
...
HeMorse93.update_ca("Na", "HCO3", prm.bC_Na_HCO3_HM93)
HeMorse93.update_ca("Na", "CO3", prm.bC_Na_CO3_HM93)
...
HeMorse93.update_ca("K", "HCO3", prm.bC_K_HCO3_HM93)
HeMorse93.update_ca("K", "CO3", prm.bC_K_CO3_HM93)
...
HeMorse93.update_ca("Ca", "HCO3", prm.bC_Ca_HCO3_HM93)
HeMorse93.update_ca("Ca", "CO3", prm.bC_Ca_CO3_HM93)
...
HeMorse93.update_ca("Mg", "HCO3", prm.bC_Mg_HCO3_HM93)
HeMorse93.update_ca("Mg", "CO3", prm.bC_Mg_CO3_HM93)
...
HeMorse93.update_ca("H", "SO4", prm.bC_H_SO4_HM92)
HeMorse93.update_ca("H", "HSO4", prm.bC_H_HSO4_HM92)
...
HeMorse93.update_aa("HSO4", "SO4", prm.theta_HSO4_SO4_HM92)
...
# lambda
HeMorse93.update_nc("CO2", "H", prm.lambd_CO2_H_HM93)
HeMorse93.update_nc("CO2", "Na", prm.lambd_CO2_Na_HM93)
HeMorse93.update_nc("CO2", "K", prm.lambd_CO2_K_HM93)
HeMorse93.update_nc("CO2", "Ca", prm.lambd_CO2_Ca_HM93)
HeMorse93.update_nc("CO2", "Mg", prm.lambd_CO2_Mg_HM93)
HeMorse93.update_na("CO2", "Cl", prm.lambd_CO2_Cl_HM93)
HeMorse93.update_na("CO2", "SO4", prm.lambd_CO2_SO4_HM93)
HeMorse93.update_na("CO2", "HSO4", prm.lambd_CO2_HSO4_HMW84)
# zeta
HeMorse93.update_nca("CO2", "H", "Cl", prm.zeta_CO2_H_Cl_HM93)
HeMorse93.update_nca("CO2", "Na", "Cl", prm.zeta_CO2_Na_Cl_HM93)
HeMorse93.update_nca("CO2", "K", "Cl", prm.zeta_CO2_K_Cl_HM93)
HeMorse93.update_nca("CO2", "Mg", "Cl", prm.zeta_CO2_Mg_Cl_HM93)
HeMorse93.update_nca("CO2", "Ca", "Cl", prm.zeta_CO2_Ca_Cl_HM93)
HeMorse93.update_nca("CO2", "H", "SO4", prm.zeta_CO2_H_SO4_HM93)
HeMorse93.update_nca("CO2", "Na", "SO4", prm.zeta_CO2_Na_SO4_HM93)
HeMorse93.update_nca("CO2", "K", "SO4", prm.zeta_CO2_K_SO4_HM93)
